...
class(irt.unconstrained)
length(irt.unconstrained) ## 5
names(irt.unconstrained) ## theta, lambda, "b", "Sigma", "Omega"

class(irt.unconstrained$theta) ##array
dim(irt.unconstrained$theta) ## 38718 x 6 x samp

## save(irt.unconstrained,
##      file="irt.unconstrained_eurobarometer943.RData")
